...
protocol and stores them in Graphite, InfluxDB, Elasticsearch, or OpenTSDB. It is meant as a
...
```
./remote_storage_adapter -elasticsearch-url=http://localhost:9200/ -elasticsearch-index=prometheus -elasticsearch-type=prometheus
```
...
```yaml
# Remote write configuration (for Graphite, OpenTSDB, Elasticsearch, or InfluxDB).
remote_write:
